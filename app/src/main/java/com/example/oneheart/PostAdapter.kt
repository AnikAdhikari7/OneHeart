...
import com.example.oneheart.Utils
...
class PostAdapter(options: FirestoreRecyclerOptions<Post>, val listener: IPostAdapter) : FirestoreRecyclerAdapter<Post, PostAdapter.PostViewHolder>(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PostViewHolder {
        val viewHolder =  PostViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.home_each_item, parent, false))
    ...
    override fun onBindViewHolder(holder: PostViewHolder, position: Int, model: Post) {
        ...
        if(isLiked) {
            ...
            holder.likeButton.setImageDrawable(ContextCompat.getDrawable(holder.likeButton.context, R.drawable.ic_disliked))
        }
